...
import kr.onit.evon.ocpp.operations.cancelreservation.CancelReservationRequest;
import kr.onit.evon.ocpp.operations.certificatesigned.CertificateSignedRequest;
import kr.onit.evon.ocpp.operations.changeavailability.ChangeAvailability;
import kr.onit.evon.ocpp.operations.changeavailability.ChangeAvailabilityRequest;
import kr.onit.evon.ocpp.operations.changeconfiguration.ChangeConfigurationRequest;
import kr.onit.evon.ocpp.operations.clearcache.ClearCacheRequest;
import kr.onit.evon.ocpp.operations.clearchargingprofile.ClearChargingProfileRequest;
import kr.onit.evon.ocpp.operations.datatransfer.*;
import kr.onit.evon.ocpp.operations.deletecertificate.DeleteCertificateRequest;
...
import kr.onit.evon.ocpp.operations.getcompositeschedule.GetCompositeScheduleRequest;
import kr.onit.evon.ocpp.operations.getconfiguration.GetConfiguration;
import kr.onit.evon.ocpp.operations.getconfiguration.GetConfigurationRequest;
import kr.onit.evon.ocpp.operations.getdiagnostics.GetDiagnosticsRequest;
import kr.onit.evon.ocpp.operations.getinstalledcertificateIds.GetInstalledCertificateIdsRequest;
import kr.onit.evon.ocpp.operations.getlocallistversion.GetLocalListVersionRequest;
import kr.onit.evon.ocpp.operations.getlog.GetLogRequest;
...
import kr.onit.evon.ocpp.operations.installcertificate.InstallCertificateRequest;
...
import kr.onit.evon.ocpp.operations.remotestarttransaction.RemoteStartTransaction;
import kr.onit.evon.ocpp.operations.remotestarttransaction.RemoteStartTransactionRequest;
import kr.onit.evon.ocpp.operations.remotestoptransaction.RemoteStopTransaction;
import kr.onit.evon.ocpp.operations.remotestoptransaction.RemoteStopTransactionRequest;
...
import kr.onit.evon.ocpp.operations.reset.Reset;
import kr.onit.evon.ocpp.operations.reset.ResetRequest;
...
import kr.onit.evon.ocpp.operations.sendlocallist.SendLocalListRequest;
import kr.onit.evon.ocpp.operations.setchargingprofile.SetChargingProfileRequest;
...
import kr.onit.evon.ocpp.operations.signedupdatefirmware.SignedUpdateFirmwareRequest;
...
import kr.onit.evon.ocpp.operations.triggermessage.TriggerMessage;
import kr.onit.evon.ocpp.operations.triggermessage.TriggerMessageRequest;
import kr.onit.evon.ocpp.operations.unlockconnector.UnlockConnector;
import kr.onit.evon.ocpp.operations.unlockconnector.UnlockConnectorRequest;
import kr.onit.evon.ocpp.operations.updatefirmware.UpdateFirmwareRequest;
import kr.onit.evon.ocpp.service.*;
