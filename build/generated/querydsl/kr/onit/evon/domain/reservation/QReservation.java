package kr.onit.evon.domain.reservation;
...
public class QReservation extends EntityPathBase<Reservation> {
    ...
    private static final long serialVersionUID = -407136063L;
    ...
    public final kr.onit.evon.domain.member.QMember user;
    ...
    public QReservation(Class<? extends Reservation> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new kr.onit.evon.domain.member.QMember(forProperty("user")) : null;
    }
