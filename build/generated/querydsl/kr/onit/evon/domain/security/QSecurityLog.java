package kr.onit.evon.domain.security;
...
public class QSecurityLog extends EntityPathBase<SecurityLog> {
    ...
    private static final long serialVersionUID = 474652991L;
    ...
    public final EnumPath<kr.onit.evon.ocpp.types.enums.Log> logType = createEnum("logType", kr.onit.evon.ocpp.types.enums.Log.class);
