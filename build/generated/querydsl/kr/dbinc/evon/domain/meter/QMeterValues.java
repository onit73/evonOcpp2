...
public class QMeterValues extends EntityPathBase<MeterValues> {
    ...
    private static final long serialVersionUID = -1994722715L;
    ...
    public final kr.dbinc.evon.domain.transaction.QTransaction transaction;
    ...
    public QMeterValues(Class<? extends MeterValues> type, PathMetadata metadata, PathInits inits) {
        ...
        this.transaction = inits.isInitialized("transaction") ? new kr.dbinc.evon.domain.transaction.QTransaction(forProperty("transaction"), inits.get("transaction")) : null;
    }
