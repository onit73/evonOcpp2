...
public class QChargingProfile extends EntityPathBase<ChargingProfile> {
    ...
    private static final long serialVersionUID = -1988691022L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QChargingProfile chargingProfile = new QChargingProfile("chargingProfile");

    public final EnumPath<kr.dbinc.evon.ocpp.types.enums.ChargingProfileKindType> chargingProfileKind = createEnum("chargingProfileKind", kr.dbinc.evon.ocpp.types.enums.ChargingProfileKindType.class);

    public final EnumPath<kr.dbinc.evon.ocpp.types.enums.ChargingProfilePurposeType> chargingProfilePurpose = createEnum("chargingProfilePurpose", kr.dbinc.evon.ocpp.types.enums.ChargingProfilePurposeType.class);

    public final QChargingSchedule chargingSchedule;

    public final NumberPath<Long> id = createNumber("id", Long.class);

    public final EnumPath<kr.dbinc.evon.ocpp.types.enums.RecurrencyKindType> recurrencyKind = createEnum("recurrencyKind", kr.dbinc.evon.ocpp.types.enums.RecurrencyKindType.class);
